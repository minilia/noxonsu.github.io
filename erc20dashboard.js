	...
	if (typeof erc20contract_address == "undefined") {
		var erc20contract_address = "0x5f1c478f23a2f14dd0a624121f61d9e74c4598a2";
	...
	function try2sell() { $("#consolesell").html('.:...::');
		if ($("#skoko").val() < 1) {
			...
			if (tosell = prompt('How many WOT you want to sell?',$("#skoko").val())) {
	...
	function try2withdrawETH() { $("#consolewithdraw").html('.:...::');
			...
			if (tosell = prompt('Enter ETH address (0x...)',erc20contract_address)) {
				sendRwTr(toamount,"","","#consolewithdraw",tosell);
					...
					$("#savethis").val("Warning! Withdraw all amounts of WOT to your own ethereum wallet! Save this information to your local device! \r\nopenkey:"+openkey+"\r\nprivkey:"+privkey);
